...
@Component({
  ...
  styles: [`
    ...
    .tarifa-price { color: var(--np-white); }
    .tarifa-row.accent .tarifa-price { color: var(--np-accent); }
    ...
    .norma-item::before { content: "→ "; color: var(--np-accent); }
  `],
})
export class TabsComponent {
  ...
  equipItems: EquipItem[] = [
    { category: 'Percusion',    name: 'Pearl Export Pro',  desc: 'Kit completo con platillos Zildjian A Series. Sala A.' },
    { category: 'Percusion',    name: 'Mapex Saturn',      desc: 'Kit profesional con hardware Saturn. Sala B.' },
    { category: 'Amplificacion',name: 'Marshall DSL40CR',  desc: 'Combo de guitarra 40W. Disponible en todas las salas.' },
    { category: 'Bajo',         name: 'Ampeg BA-210',      desc: 'Combo de bajo 450W. Salas A y B.' },
    { category: 'Mezcla',       name: 'Behringer X32',     desc: 'Mesa digital 32 canales con efectos. Sala B.' },
  ];
