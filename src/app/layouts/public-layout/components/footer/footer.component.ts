    ...
    <footer class="np-footer" role="contentinfo">
      <div class="np-footer-brand">
        <a class="np-logo" routerLink="/">
          <img
            src="/assets/logo_null.png"
            alt="Null Pointer Studio"
            class="np-logo-img"
            width="30"
            height="30"
          />
      ...
      <div class="np-footer-col">
        ...
        <div class="np-social" aria-label="Redes sociales">
          ...
          >
            ...
            >
              <path
                d="M13.5 21v-7.9h2.65l.4-3.08h-3.05V8.05c0-.89.25-1.5 1.52-1.5h1.63V3.8c-.28-.04-1.25-.12-2.38-.12-2.36 0-3.97 1.44-3.97 4.08v2.27H7.65v3.08h2.65V21h3.2Z"
              />
            </svg>
          </a>
          <a
          ...
          >
            ...
            >
              <path
                d="M16.6 3c.36 2.16 1.85 3.87 4.14 4.1v2.75c-1.42.13-2.68-.3-4.14-1.1v6.4c0 3.3-2.42 5.85-5.83 5.85-3.4 0-5.87-2.55-5.87-5.85 0-3.28 2.5-5.83 5.87-5.83.34 0 .78.03 1.06.09v2.9a3.1 3.1 0 0 0-1.06-.2 3.05 3.05 0 0 0-3.06 3.04 3.05 3.05 0 0 0 3.06 3.05 3.13 3.13 0 0 0 3.15-3.13V3h2.68Z"
              />
            </svg>
          </a>
          <a
